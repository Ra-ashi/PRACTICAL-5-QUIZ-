...
function changeToUnchecked(questionName) {
    ...
    const index = "[data-choice-id='"+ id + "']" ;//+ "[data-question-id='" +
    questionName +"']";
    //console.log(index);
    ...
    outputTitle.innerHTML = "You got: " +
    RESULTS_MAP[currentAnswer['two']]['title'];
    outputContent.innerHTML =
    RESULTS_MAP[currentAnswer['two']]['contents'];
    } else{
    outputTitle.innerHTML = "You got: " +
    RESULTS_MAP[currentAnswer['one']]['title'];
    outputContent.innerHTML =
    RESULTS_MAP[currentAnswer['one']]['contents'];
    }
